...
<div id="content" class="content">
  <div class="d-flex flex-wrap justify-content-between subheader align-content-stretch align-items-stretch">
    <div class="break-main d-flex subheader-main justify-content-start align-content-stretch align-items-stretch">
      <h3 class="subheader-main-h">Τρέχουσες Πτυχιακές</h3>
  ...
  <div class="d-flex subheader-main justify-content-start align-content-stretch align-items-stretch">
        <div class="dropdown" id="dropdown-test">
              <input type="text" autocomplete="off" class="input-search-icon input-drop dropdown-toggle form-control" name="search-landing" id="search-test" placeholder="Αναζήτηση Καθηγητή, Κατηγορία" aria-haspopup="true" aria-expanded="false">
