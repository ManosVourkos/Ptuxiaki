...
<body>
  ...
  <div id="content" class="content">
    <div class="d-flex flex-wrap justify-content-between subheader align-content-stretch align-items-stretch">
      <div class="break-main d-flex subheader-main justify-content-start align-content-stretch align-items-stretch">
        <h3 class="subheader-main-h">Προβολή Πτυχιακής</h3>
      </div>
 ...
 <div class="modal fade" id="ModalStudent" tabindex="-1" role="dialog" aria-labelledby="ModalStudentTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
     <div class="modal-content">
       <div class="modal-header">
         <h5 class="modal-title">Αίτηση Φοιτητή</h5>
         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
           <span aria-hidden="true">&times;</span>
         </button>
       </div>
       ...
       <div class="modal-footer">
         <button id="modal-dismiss" type="button" class="btn btn-secondary" data-dismiss="modal">Όχι</button>
         <button id="modal-button-student" type="button" class="btn btn-primary">
           <div id="modal-button-spin-student" class="" role="status">
             <span class="sr-only">Loading...</span>
           </div>
           <span id="modal-button-text-student">Ναι</span>
         </button>
       </div>
     </div>
   </div>
 ...
 <div class="modal fade" id="ModalComplete" tabindex="-1" role="dialog" aria-labelledby="ModalCompleteTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
     <div class="modal-content">
       <div class="modal-header">
         <h5 class="modal-title">Ολοκλήρωση Πτυχιακής</h5>
         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
           <span aria-hidden="true">&times;</span>
         </button>
       </div>
       ...
       <div class="modal-footer">
         <button id="modal-dismiss" type="button" class="btn btn-secondary" data-dismiss="modal">Όχι</button>
         <button id="modal-button-complete" type="button" class="btn btn-primary">
           <div id="modal-button-spin-complete" class="" role="status">
             <span class="sr-only">Loading...</span>
           </div>
           <span id="modal-button-text-complete">Ναι</span>
         </button>
       </div>
     </div>
   </div>
 ...
 <div class="modal fade" id="ModalRepublish" tabindex="-1" role="dialog" aria-labelledby="ModalRepublishTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
     <div class="modal-content">
       <div class="modal-header">
         <h5 class="modal-title">Επαναναδημοσίευση Πτυχιακής</h5>
         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
           <span aria-hidden="true">&times;</span>
         </button>
       </div>
       ...
       <div class="modal-footer">
         <button id="modal-dismiss" type="button" class="btn btn-secondary" data-dismiss="modal">Όχι</button>
         <button id="modal-button-republish" type="button" class="btn btn-primary">
           <div id="modal-button-spin-republish" class="" role="status">
             <span class="sr-only">Loading...</span>
           </div>
           <span id="modal-button-text-republish">Ναι</span>
         </button>
       </div>
     </div>
   </div>
 ...
 <div class="modal fade" id="ModalTerminate" tabindex="-1" role="dialog" aria-labelledby="ModalTerminateTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
     <div class="modal-content">
       <div class="modal-header">
         <h5 class="modal-title">Διακοπή Εκπόνησης Πτυχιακής</h5>
         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
           <span aria-hidden="true">&times;</span>
         </button>
       </div>
       ...
       <div class="modal-footer">
         <button id="modal-dismiss" type="button" class="btn btn-secondary" data-dismiss="modal">Όχι</button>
         <button id="modal-button-terminate" type="button" class="btn btn-primary">
           <div id="modal-button-spin-terminate" class="" role="status">
             <span class="sr-only">Loading...</span>
           </div>
           <span id="modal-button-text-terminate">Ναι</span>
         </button>
       </div>
     </div>
   </div>
   ...
   <!--Created JS -->
     ...
     <script src="js/fetchdiploma.js"></script>
