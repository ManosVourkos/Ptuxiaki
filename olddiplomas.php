...
<div id="content" class="content">
  <div class="d-flex flex-wrap justify-content-between subheader align-content-stretch align-items-stretch">
    ...
    <div class="d-flex flex-nowrap">
          <h3 class="subheader-main-h">Παλαιότερες Πτυχιακές</h3>
          <a id="home" class="navigation-a" href="#"><i class="fas fa-home"></i></a>
          <span class="d-flex align-items-center"><i class="fas fa-circle dot"></i></span>
          <span id="navigation" class="navigation-color">Όλες οι πτυχιακές</span>
      </div>
    </div>
  ...
  <div class="d-flex subheader-main justify-content-end align-content-stretch align-items-stretch  px-3 mx-4">
  <div class="d-flex subheader-main justify-content-start align-content-stretch align-items-stretch">

        <h3 class="subheader-main-h my-auto">Ταξινόμηση</h3>
        <div class="dropdown" id="dropdown-test">
              <input type="text" autocomplete="off" class="input-drop dropdown-toggle form-control" name="search-landing" id="search-test" placeholder="Αναζήτηση..." aria-haspopup="true" aria-expanded="false">
 ...
 <div class="modal fade" id="ModalMinimum" tabindex="-1" role="dialog" aria-labelledby="ModalMinimumTitle" data-toggle="modal" data-target="#ModalMinimum" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
     <div class="modal-content">
       ...
       <div class="modal-body">
         <p>Σε αυτό το εξάμηνο έχεις δημιουργήσει λιγότερες πτυχιακές.</p>
       </div>
       <div class="modal-footer">
         <button type="button" class="btn btn-secondary" data-dismiss="modal">OK</button>
       </div>
 ...
 <div class="modal fade" id="ModalRepublish" tabindex="-1" role="dialog" aria-labelledby="ModalRepublishTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
     <div class="modal-content">
       <div class="modal-header">
         <h5 class="modal-title">Επαναδημοσίευση Πτυχιακής</h5>
         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
           <span aria-hidden="true">&times;</span>
         </button>
       </div>
 ...
 <div class="modal fade" id="ModalStatus" tabindex="-1" role="dialog" aria-labelledby="ModalStatusTitle" aria-hidden="true">
   ...
   <!--Created JS -->
     ...
     <script src="js/olddiplomas.js"></script>
